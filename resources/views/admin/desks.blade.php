...
{{--                                        @foreach($statuses as $status)--}}
                                        <div class="card" v-for="desk in desks">

                                            <!-- Card header -->
                                            <div class="d-flex align-items-center justify-content-between card-header mb-1" role="tab" :id="'heading' + desk.id">
                                                <a data-toggle="collapse" data-parent="#accordionEx7" :href="'#collapse' + desk.id" aria-expanded="true"
                                                   :aria-controls="'collapse' + desk.id">
                                                    <h5 class="mb-0 light-gold text-uppercase">
                                                        @{{desk.desk}} </i>
                                                    </h5>
                                                </a>
                                                <div class="delete_icon">
                                                    <span @click="deleteDesk(desk.id)"><i class="fa fa-trash" aria-hidden="true"></i> </span>
                                                </div>
                                            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Allow New Desk</h4>
                        </div>
                        <div class="modal-body">

                            <div class="row form-group">
                                <label class="col-sm-4" for="title">DESK: </label>
                                <div class="col-sm-12">

                                    <input class="form-control"  v-model="new_desk">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" @click="createDesk()" class="btn btn-primary" id="save-event">Save changes</button>
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
            </div>
    ...
    <script>
        var vm = new Vue({
            ...
            methods: {
                ...
                getDesks:function() {
                    let self=this;
                    axios.get('{{URL::to('/admin/get_desks/')}}', {
                    }).then(function(response) {
                        self.desks = response.data;
                ...
                createDesk:function() {
                    ...
                    let self=this;
                    axios.post('{{URL::to('/admin/create_desk')}}', {
                        desk:self.new_desk,
                    }).then(function(response) {
                ...
                deleteDesk:function(id) {
                    ...
                    let self=this;
                    axios.post('{{URL::to('/admin/delete_desk')}}', {
                        id:id,
                    }).then(function(response) {
