                           ...
                           <div class="box-outer">
                               ...
                               <div class="box-inner">
                                ...
                                <thead class="searchRow">
                                    <tr>
                                        <th class="amountInput" data-priority="1">Account</th>
                                        ...
                                        <th class="noInputInput" data-priority="3">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($requests->sortByDesc('id') as $request)
                                <tr>
                                    <td>@if(isset($request->closure_account_type)) @if (($request->closure_account_type) === 'black_panther')
                                    ...
                                    <td><a @click="setClosure({{$request->user_id}}, 1)" class="btn btn-success mr-2">Enable</a><a @click="setClosure({{$request->user_id}}, 0)" class="btn btn-danger">Disable</a></td>
                                </tr>
                                @endforeach
                                </tbody>
                            </table>
