                ...
                <div class="col-xl-12 ">
                    <div class="m-t--4">
                        <div class="border-0  mt-2">
                            <div class="row">
                                <div class="col-xl-5">
                                    <h3 v-if="multiUsers.length">@{{ multiUsers.length }} Users Selected</h3>
                                    <h3 v-else>Users</h3>
                                </div>
                                ...
                                <a class="btn btn-lg btn-dark text-white mr-2" data-toggle="modal" data-target="#multiAssign">
                                 Assign Users  (@{{ multiUsers.length }})
                                </a>

                                @endif

                                @if(logged_in()->can_add_deposit || logged_in()->account_id === 'admin')
                                ...
                                @if(logged_in()->can_add_credit || logged_in()->account_id === 'admin')
                                ...
                                <a class="btn btn-lg btn-dark text-white mr-2" data-toggle="modal" data-target="#multiEmail">
                                        ...
                                        <select name="manager[]" multiple id="check_manager" class="select custom-select check_inputs" placeholder="Manager" type="text">
                                            ...
                                            <option value="12345">None</option>
                                                ...
                                                @foreach ($manager as $mngr)
                                                    <option value="{{$mngr->id}}"> {{$mngr->name}}
                                                    </option>
                                                @endforeach
