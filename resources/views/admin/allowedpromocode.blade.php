...
{{--                                        @foreach($statuses as $status)--}}
                                        <div class="card" v-for="promo in allowedpromocode">

                                            <!-- Card header -->
                                            <div class="d-flex align-items-center justify-content-between card-header mb-1" role="tab" :id="'heading' + promo.id">
                                                <a data-toggle="collapse" data-parent="#accordionEx7" :href="'#collapse' + promo.id" aria-expanded="true"
                                                   :aria-controls="'collapse' + promo.id" style="width: 54%; display: flex; align-items: center; justify-content: space-between;">
                                                ...
                                                <div class="delete_icon">
                                                    <span @click="deleteStatus(promo.id)"><i class="fa fa-trash" aria-hidden="true"></i> </span>
                                                </div>
                                            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Allow New Promocode</h4>
                        </div>
                        <div class="modal-body">

                            <div class="row form-group">
                                <label class="col-sm-4" for="title">PromoCode: </label>
                                <div class="col-sm-12">

                                    <input class="form-control"  v-model="new_allowedpromocode">

                                </div>
                                <br>
                                <br>
                                <br>
                                <label class="col-sm-4" for="title">Description: </label>
                                <div class="col-sm-12">
        ...
        var vm = new Vue({
            ...
            methods: {
                ...
                getStatuses:function() {
                    let self=this;
                    axios.get('{{URL::to('/admin/get_allowedpromocode/')}}', {
                    }).then(function(response) {
                        self.allowedpromocode = response.data;
                ...
                createStatus:function() {
                    ...
                    let self=this;
                    axios.post('{{URL::to('/admin/create_allowedpromocode')}}', {
                        promocode:self.new_allowedpromocode,
                ...
                deleteStatus:function(id) {
                    ...
                    let self=this;
                    axios.post('{{URL::to('/admin/delete_allowedpromocode')}}', {
                        id:id,
                    }).then(function(response) {
