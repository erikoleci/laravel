                    ...
                    <div class="m-t--4">
                        ...
                        <div class="col-md-12">
                            <div class="box-outer">
                                ...
                                <tbody>
                                @if(isset($credits))
                                @foreach($credits->sortByDesc('id') as $credit)
                                    @if($credit->amount != 0)
                                <tr class="">
                                    <td>@if(isset($credit->user->account_id)) @if (($credit->user->account_id) === 'black_panther')
                                    ...
                                    <td>
                                        <a @click="delete_credit({{$credit->id}})"><i class="fa fa-times font-20 deleteTransaction"></i></a>
                                    </td>
                ...
                submitPromo() {
                    ...
                    axios.post('{{URL::to('save_credit')}}', {
                        ...
                        {{--window.location.href = '{{URL::to('personal_info/')}}'+'?msg='+response.data;--}}
                            window.location.href = '{{URL::to('admin/credits/')}}';
