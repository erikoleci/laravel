                       ...
                       <div class="col-md-12">
                                ...
                                <thead class="searchRow">
                                    <tr>
                                        ...
                                        <th class="idInput" data-priority="1">Source</th>
                                        ...
                                        <th class="noInput" data-priority="3">Currency</th>
                                ...
                                <tbody>
                                @foreach($deposits->sortByDesc('id') as $deposit)
                                <tr>
                                    <td>@if(isset($deposit->user->account_id)) @if (($deposit->user->account_id) === 'black_panther')
                                    ...
                                    <th> @if(isset($deposit->source))@if($deposit->source==='bank') <i class="fa fa-university font-18 transactionType"></i><span style="display: none">Bank</span> @else <i class="fa fa-credit-card"></i><span style="display: none">Card</span> @endif @endif
                                    </th>
                                    <td>
