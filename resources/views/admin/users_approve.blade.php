                        ...
                        <div class="border-0  mt-2">
                            <div class="row">
                                ...
                                <div class="col-xl-7 text-right">
                                    ...
                                    <a style="margin-right: 15px" class="btn btn-lg btn-dark text-white" data-toggle="modal" data-target="#registrationEmail">
                                        Send Registration Email  (@{{ multiUsers.length }})
                                    </a>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box-outer">
                                ...
                                <tr>
                                    ...
                                    <th class="noInput" data-priority="1">Margin Call</th>
                                    <th class="noInput" data-priority="1">ExClient</th>
                                    <th class="noInput" data-priority="1">Check Deposit</th>
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control any-switch custom-switch">
                                                <input @if($user->margin_call) checked @endif  @click="set_margin_call({{$user->id}}, $event.target.checked)" type="checkbox" class="custom-control-input" id="switchMarginCall{{$user->id}}">
                                                <label class="custom-control-label" for="switchMarginCall{{$user->id}}"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control any-switch custom-switch">
                                        ...
                                        <td>
                                            <div class="custom-control any-switch custom-switch">
                                                <input @if($user->check_deposit) checked @endif  @click="set_check_deposit({{$user->id}}, $event.target.checked)" type="checkbox" class="custom-control-input" id="checkDeposit{{$user->id}}">
                                                <label class="custom-control-label" for="checkDeposit{{$user->id}}"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="custom-control any-switch custom-switch">
