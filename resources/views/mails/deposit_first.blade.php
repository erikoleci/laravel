...
<![endif]-->
                                ...
                                <tr>
                                  <td style='padding:0px 20px;vertical-align:top;'>
                                    <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='' width='100%'>
                                      <tr>
                                        <td align='' style='font-size:0px;padding:0px;word-break:break-word;'>
    ...
    justify-content: center;">
                                                <a href>
                                                  <img style="margin: auto;text-align: center;" align='center' alt='Logo'  padding='5px' src='https://fgm-group.com/images/logo.png' width='55' />
                                                </a>
                                              </td>
                            ...
                            <tr>
                              <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                 Please click on the button below to continue with the procedure.
                                </div>
                              </td>
                            </tr>
                          </table>
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                      <td style='width:100px;'>
                                                        <img alt='step 1' height='auto' src='https://client.fgm-group.com/images/small/0oYLLViRBKv7a0Lzh6vC_v3_03.jpg' style='border:none;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;' width='100' />
                                                      </td>
                                                    </tr>
                                                  </tbody>
                                                </table>
                                              ...
                                              <td width='33%'>
                                                <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:collapse;border-spacing:0px;'>
                                                  <tbody>
                                                    <tr>
                                                      <td style='width:100px;'>
                                                        <img alt='step 2 highlighted' height='auto' src='https://client.fgm-group.com/images/small/YL3H3V5bRyGuy6pess9T_v33_04.jpg' style='border:none;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;' width='100' />
                                                      </td>
                                                    </tr>
                                                  </tbody>
                                                </table>
                                              ...
                                              <td width='33%'>
                                                <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:collapse;border-spacing:0px;'>
                                                  <tbody>
                                                    <tr>
                                                      <td style='width:100px;'>
                                                        <img alt='step 3' height='auto' src='https://client.fgm-group.com/images/small/YSTlgtgaTSa897tPTUhl_v3_05.jpg' style='border:none;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;' width='100' />
                                                      </td>
                                                    </tr>
                                                  </tbody>
                                                </table>
                                    ...
                                    <tr>
                                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;' vertical-align='middle'>
                                        <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:separate;line-height:100%;'>
                                          <tr>
                                            <td align='center' bgcolor='#ff6f6f' role='presentation' style='background:linear-gradient(101deg, #aea367c9 0%, #d0c385 40%, rgb(197 180 112) 60%);border:none;border-radius:5px;cursor:auto;padding:10px 25px;' valign='middle'>
                                              <a href='https://mt5apps.com/pay3/E5985823' style='color:#ffffff;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;font-weight:400;line-height:21px;margin:0;text-decoration:none;text-transform:none;' target='_blank'>
                                                CONTINUE
                                              </a>
                                            </td>
                                          </tr>
