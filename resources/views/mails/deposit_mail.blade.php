          ...
          <table cellspacing="0" cellpadding="0" width="100%">
            <tr>
              <td class="hide-for-mobile" style="padding:30px 0 10px 0;">
                <img width="40" height="31" src="https://fgm-group.com/images/logo.png" alt="logo" />
              </td>
            </tr>
            ...
            <tr>
              <td class="hide-for-mobile"  height="150" valign="top" >
                <b>
                  <span>BITFEX LIMITED</span>
                  </b>
                <br>
                <span>Your deposit is completed.</span>
              </td>
            </tr>
